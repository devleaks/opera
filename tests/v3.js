...
const hexagons = h3.polyfill(polygon, 6);
console.log(hexagons);
// They are the same as V4
// [
...
const coordinates = hexagons.map( (f) => h3.h3ToGeoBoundary(f, false) );
...
require('fs').writeFile('out3.geojson', JSON.stringify(fc), (error) => {
    if (error) {
        throw error;
    }
});
console.log("Feature collection saved in out3.geojson");
